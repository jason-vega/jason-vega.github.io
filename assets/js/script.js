...
function addProject(project, projectListContainer, background, justifyImage) {
  var projectHtml = '<div class="card rounded-0 bg-' + background + ' border-' +
    ...
    'd-sm-none"><div class="col-auto text-center"><img src="' + project.imageUrl + 
		'" class="project-preview-sm rounded-circle shadow" alt="' + project.title + 
		'"></div></div><div class="row no-gutters align-items-center">';
  ...
  if (justifyImage == "right") {
    projectHtml += '<div class="col-auto d-none d-sm-block"><img ' + 
      'src="' + project.imageUrl + '" class="card-img rounded-0 ' + 
			'project-preview" alt="' + project.title + '"></div>';
  }
